...
| Project            | Description |
|:-------------------|:------------|
| [Sensor](Sensor)   | This project implements a simple sensor that gets its values from the Internet and publishes it on an MQTT Broker. It publishes the information in four different ways: Unsecure and Unstructured, Unsecure and Structured, Secured but public, Secured and Confidential. |
| [Display](Display) | This project presents sensor information published by the Sensor project. It displays information generated by all four methods transmitted. |
